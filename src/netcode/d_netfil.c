...
consvar_t cv_maxsend = CVAR_INIT ("maxsend", "204800", CV_SAVE|CV_NETVAR, maxsend_cons_t, NULL);
...
consvar_t cv_downloadspeed = CVAR_INIT ("downloadspeed", "50", CV_SAVE|CV_NETVAR, downloadspeed_cons_t, NULL);
