...
// Begin JS library code
  ...
  function _SRB2_ConnectTo(addr, port) {
  ...
  function _SRB2_NetworkSend(node_id, data_ptr, len) {
  ...
  function _SRB2_RequestServerList(name) {
...
/** @type {function(string, boolean=, number=)} */
  ...
  var _eglGetConfigAttrib = (display, config, attribute, value) => {
      ...
      case 0x3020: // EGL_BUFFER_SIZE
        HEAP32[((value)>>2)] = EGL.contextAttributes.alpha ? 32 : 24;checkInt32(EGL.contextAttributes.alpha ? 32 : 24);
        return 1;
      case 0x3021: // EGL_ALPHA_SIZE
        HEAP32[((value)>>2)] = EGL.contextAttributes.alpha ? 8 : 0;checkInt32(EGL.contextAttributes.alpha ? 8 : 0);
        return 1;
      case 0x3022: // EGL_BLUE_SIZE
        HEAP32[((value)>>2)] = 8;checkInt32(8);
        return 1;
      ...
      case 0x3025: // EGL_DEPTH_SIZE
        HEAP32[((value)>>2)] = EGL.contextAttributes.depth ? 24 : 0;checkInt32(EGL.contextAttributes.depth ? 24 : 0);
        return 1;
      case 0x3026: // EGL_STENCIL_SIZE
        HEAP32[((value)>>2)] = EGL.contextAttributes.stencil ? 8 : 0;checkInt32(EGL.contextAttributes.stencil ? 8 : 0);
        return 1;
      case 0x3027: // EGL_CONFIG_CAVEAT
        // We can return here one of EGL_NONE (0x3038), EGL_SLOW_CONFIG (0x3050) or EGL_NON_CONFORMANT_CONFIG (0x3051).
        HEAP32[((value)>>2)] = 0x3038;checkInt32(0x3038);
        return 1;
      case 0x3028: // EGL_CONFIG_ID
        HEAP32[((value)>>2)] = 62002;checkInt32(62002);
        return 1;
      case 0x3029: // EGL_LEVEL
        HEAP32[((value)>>2)] = 0;checkInt32(0);
        return 1;
      case 0x302A: // EGL_MAX_PBUFFER_HEIGHT
        HEAP32[((value)>>2)] = 4096;checkInt32(4096);
        return 1;
      case 0x302B: // EGL_MAX_PBUFFER_PIXELS
        HEAP32[((value)>>2)] = 16777216;checkInt32(16777216);
        return 1;
      ...
      case 0x3031: // EGL_SAMPLES
        HEAP32[((value)>>2)] = EGL.contextAttributes.antialias ? 4 : 0;checkInt32(EGL.contextAttributes.antialias ? 4 : 0);
        return 1;
      case 0x3032: // EGL_SAMPLE_BUFFERS
        HEAP32[((value)>>2)] = EGL.contextAttributes.antialias ? 1 : 0;checkInt32(EGL.contextAttributes.antialias ? 1 : 0);
        return 1;
      case 0x3033: // EGL_SURFACE_TYPE
        HEAP32[((value)>>2)] = 0x4;checkInt32(0x4);
        return 1;
      ...
      case 0x303F: // EGL_COLOR_BUFFER_TYPE
        ...
        HEAP32[((value)>>2)] = 0x308E;checkInt32(0x308E);
        return 1;
  ...
  var _emscripten_get_canvas_element_size = (target, width, height) => {
      ...
      if (!canvas) return -4;
      HEAP32[((width)>>2)] = canvas.width;checkInt32(canvas.width);
      HEAP32[((height)>>2)] = canvas.height;checkInt32(canvas.height);
    };
  ...
  var _emscripten_get_main_loop_timing = (mode, value) => {
      ...
      if (value) HEAP32[((value)>>2)] = MainLoop.timingValue;checkInt32(MainLoop.timingValue);
    };
  ...
  var _emscripten_get_screen_size = (width, height) => {
      HEAP32[((width)>>2)] = screen.width;checkInt32(screen.width);
      HEAP32[((height)>>2)] = screen.height;checkInt32(screen.height);
    };
  ...
  var fillFullscreenChangeEventData = (eventStruct) => {
      ...
      HEAP32[(((eventStruct)+(260))>>2)] = reportedElement?.clientWidth ?? 0;checkInt32(reportedElement?.clientWidth ?? 0);
      HEAP32[(((eventStruct)+(264))>>2)] = reportedElement?.clientHeight ?? 0;checkInt32(reportedElement?.clientHeight ?? 0);
  ...
  var fillVisibilityChangeEventData = (eventStruct) => {
      ...
      // Assigning a boolean to HEAP32 with expected type coercion.
      /** @suppress{checkTypes} */
      HEAP8[eventStruct] = document.hidden;checkInt8(document.hidden);
      HEAP32[(((eventStruct)+(4))>>2)] = visibilityState;checkInt32(visibilityState);
    };
  ...
  var registerWheelEventCallback = (target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) => {
      ...
      var wheelHandlerFunc = (e) => {
        ...
        HEAP32[(((wheelEvent)+(88))>>2)] = e["deltaMode"];checkInt32(e["deltaMode"]);
...
var ASM_CONSTS = {
  2421584: () => { try { StartedMainLoopCallback(); } catch (err) { console.log('Faild to find StartedMainLoopCallback()'); } },  
 2421691: ($0) => { var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return reply.length === 1 ? reply.charCodeAt(0) : -1; },  
 2421906: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 2422053: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
 2422287: ($0) => { if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { if ((typeof navigator.userActivation) === 'undefined') { autoResumeAudioContext(SDL2.audioContext); } } } return SDL2.audioContext === undefined ? -1 : 0; },  
 2422839: () => { var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate; },  
 2422907: ($0, $1, $2, $3) => { var SDL2 = Module['SDL2']; var have_microphone = function(stream) { if (SDL2.capture.silenceTimer !== undefined) { clearInterval(SDL2.capture.silenceTimer); SDL2.capture.silenceTimer = undefined; SDL2.capture.silenceBuffer = undefined } SDL2.capture.mediaStreamNode = SDL2.audioContext.createMediaStreamSource(stream); SDL2.capture.scriptProcessorNode = SDL2.audioContext.createScriptProcessor($1, $0, 1); SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) { if ((SDL2 === undefined) || (SDL2.capture === undefined)) { return; } audioProcessingEvent.outputBuffer.getChannelData(0).fill(0.0); SDL2.capture.currentCaptureBuffer = audioProcessingEvent.inputBuffer; dynCall('vp', $2, [$3]); }; SDL2.capture.mediaStreamNode.connect(SDL2.capture.scriptProcessorNode); SDL2.capture.scriptProcessorNode.connect(SDL2.audioContext.destination); SDL2.capture.stream = stream; }; var no_microphone = function(error) { }; SDL2.capture.silenceBuffer = SDL2.audioContext.createBuffer($0, $1, SDL2.audioContext.sampleRate); SDL2.capture.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { SDL2.capture.currentCaptureBuffer = SDL2.capture.silenceBuffer; dynCall('vp', $2, [$3]); }; SDL2.capture.silenceTimer = setInterval(silence_callback, ($1 / SDL2.audioContext.sampleRate) * 1000); if ((navigator.mediaDevices !== undefined) && (navigator.mediaDevices.getUserMedia !== undefined)) { navigator.mediaDevices.getUserMedia({ audio: true, video: false }).then(have_microphone).catch(no_microphone); } else if (navigator.webkitGetUserMedia !== undefined) { navigator.webkitGetUserMedia({ audio: true, video: false }, have_microphone, no_microphone); } },  
 2424600: ($0, $1, $2, $3) => { var SDL2 = Module['SDL2']; SDL2.audio.scriptProcessorNode = SDL2.audioContext['createScriptProcessor']($1, 0, $0); SDL2.audio.scriptProcessorNode['onaudioprocess'] = function (e) { if ((SDL2 === undefined) || (SDL2.audio === undefined)) { return; } if (SDL2.audio.silenceTimer !== undefined) { clearInterval(SDL2.audio.silenceTimer); SDL2.audio.silenceTimer = undefined; SDL2.audio.silenceBuffer = undefined; } SDL2.audio.currentOutputBuffer = e['outputBuffer']; dynCall('vp', $2, [$3]); }; SDL2.audio.scriptProcessorNode['connect'](SDL2.audioContext['destination']); if (SDL2.audioContext.state === 'suspended') { SDL2.audio.silenceBuffer = SDL2.audioContext.createBuffer($0, $1, SDL2.audioContext.sampleRate); SDL2.audio.silenceBuffer.getChannelData(0).fill(0.0); var silence_callback = function() { if ((typeof navigator.userActivation) !== 'undefined') { if (navigator.userActivation.hasBeenActive) { SDL2.audioContext.resume(); } } SDL2.audio.currentOutputBuffer = SDL2.audio.silenceBuffer; dynCall('vp', $2, [$3]); SDL2.audio.currentOutputBuffer = undefined; }; SDL2.audio.silenceTimer = setInterval(silence_callback, ($1 / SDL2.audioContext.sampleRate) * 1000); } },  
 2425775: ($0, $1) => { var SDL2 = Module['SDL2']; var numChannels = SDL2.capture.currentCaptureBuffer.numberOfChannels; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.capture.currentCaptureBuffer.getChannelData(c); if (channelData.length != $1) { throw 'Web Audio capture buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } if (numChannels == 1) { for (var j = 0; j < $1; ++j) { setValue($0 + (j * 4), channelData[j], 'float'); } } else { for (var j = 0; j < $1; ++j) { setValue($0 + (((j * numChannels) + c) * 4), channelData[j], 'float'); } } } },  
 2426380: ($0, $1) => { var SDL2 = Module['SDL2']; var buf = $0 >>> 2; var numChannels = SDL2.audio.currentOutputBuffer['numberOfChannels']; for (var c = 0; c < numChannels; ++c) { var channelData = SDL2.audio.currentOutputBuffer['getChannelData'](c); if (channelData.length != $1) { throw 'Web Audio output buffer length mismatch! Destination size: ' + channelData.length + ' samples vs expected ' + $1 + ' samples!'; } for (var j = 0; j < $1; ++j) { channelData[j] = HEAPF32[buf + (j*numChannels + c)]; } } },  
 2426869: ($0) => { var SDL2 = Module['SDL2']; if ($0) { if (SDL2.capture.silenceTimer !== undefined) { clearInterval(SDL2.capture.silenceTimer); } if (SDL2.capture.stream !== undefined) { var tracks = SDL2.capture.stream.getAudioTracks(); for (var i = 0; i < tracks.length; i++) { SDL2.capture.stream.removeTrack(tracks[i]); } } if (SDL2.capture.scriptProcessorNode !== undefined) { SDL2.capture.scriptProcessorNode.onaudioprocess = function(audioProcessingEvent) {}; SDL2.capture.scriptProcessorNode.disconnect(); } if (SDL2.capture.mediaStreamNode !== undefined) { SDL2.capture.mediaStreamNode.disconnect(); } SDL2.capture = undefined; } else { if (SDL2.audio.scriptProcessorNode != undefined) { SDL2.audio.scriptProcessorNode.disconnect(); } if (SDL2.audio.silenceTimer !== undefined) { clearInterval(SDL2.audio.silenceTimer); } SDL2.audio = undefined; } if ((SDL2.audioContext !== undefined) && (SDL2.audio === undefined) && (SDL2.capture === undefined)) { SDL2.audioContext.close(); SDL2.audioContext = undefined; } },  
 2427875: ($0) => { window.open(UTF8ToString($0), "_blank") },  
 2427915: ($0, $1) => { alert(UTF8ToString($0) + "\n\n" + UTF8ToString($1)); },  
 2427972: () => { return window.innerWidth; },  
 2428002: () => { return window.innerHeight; },  
 2428033: ($0, $1, $2) => { var w = $0; var h = $1; var pixels = $2; if (!Module['SDL2']) Module['SDL2'] = {}; var SDL2 = Module['SDL2']; if (SDL2.ctxCanvas !== Module['canvas']) { SDL2.ctx = Browser.createContext(Module['canvas'], false, true); SDL2.ctxCanvas = Module['canvas']; } if (SDL2.w !== w || SDL2.h !== h || SDL2.imageCtx !== SDL2.ctx) { SDL2.image = SDL2.ctx.createImageData(w, h); SDL2.w = w; SDL2.h = h; SDL2.imageCtx = SDL2.ctx; } var data = SDL2.image.data; var src = pixels / 4; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = 0xff; src++; dst += 4; } } else { if (SDL2.data32Data !== data) { SDL2.data32 = new Int32Array(data.buffer); SDL2.data8 = new Uint8Array(data.buffer); SDL2.data32Data = data; } var data32 = SDL2.data32; num = data32.length; data32.set(HEAP32.subarray(src, src + num)); var data8 = SDL2.data8; var i = 3; var j = i + 4*num; if (num % 8 == 0) { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; data8[i] = 0xff; i = i + 4 | 0; } } else { while (i < j) { data8[i] = 0xff; i = i + 4 | 0; } } } SDL2.ctx.putImageData(SDL2.image, 0, 0); },  
 2429499: ($0, $1, $2, $3, $4) => { var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels / 4; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf; },  
 2430487: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 2430570: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } }
};

// Imports from the Wasm binary.
var _COM_ImmedExecute = Module['_COM_ImmedExecute'] = makeInvalidEarlyAccess('_COM_ImmedExecute');
var _pause_loop = Module['_pause_loop'] = makeInvalidEarlyAccess('_pause_loop');
var _resume_loop = Module['_resume_loop'] = makeInvalidEarlyAccess('_resume_loop');
var _SRB2_SendGreenTerminal = Module['_SRB2_SendGreenTerminal'] = makeInvalidEarlyAccess('_SRB2_SendGreenTerminal');
var _malloc = Module['_malloc'] = makeInvalidEarlyAccess('_malloc');
var _free = Module['_free'] = makeInvalidEarlyAccess('_free');
var _SRB2_SetDirectAction = Module['_SRB2_SetDirectAction'] = makeInvalidEarlyAccess('_SRB2_SetDirectAction');
var _SRB2_SetDirectAction2 = Module['_SRB2_SetDirectAction2'] = makeInvalidEarlyAccess('_SRB2_SetDirectAction2');
var _SRB2_SetAnalogStick = Module['_SRB2_SetAnalogStick'] = makeInvalidEarlyAccess('_SRB2_SetAnalogStick');
var _SRB2_ClearAnalogStick = Module['_SRB2_ClearAnalogStick'] = makeInvalidEarlyAccess('_SRB2_ClearAnalogStick');
var _SRB2_KeyboardNeeded = Module['_SRB2_KeyboardNeeded'] = makeInvalidEarlyAccess('_SRB2_KeyboardNeeded');
var _fflush = makeInvalidEarlyAccess('_fflush');
var _strerror = makeInvalidEarlyAccess('_strerror');
var _SRB2_LOG = Module['_SRB2_LOG'] = makeInvalidEarlyAccess('_SRB2_LOG');
var _SRB2_ClearServerList = Module['_SRB2_ClearServerList'] = makeInvalidEarlyAccess('_SRB2_ClearServerList');
var _SRB2_AddServerToList = Module['_SRB2_AddServerToList'] = makeInvalidEarlyAccess('_SRB2_AddServerToList');
var _SRB2_FinishServerList = Module['_SRB2_FinishServerList'] = makeInvalidEarlyAccess('_SRB2_FinishServerList');
var _SRB2_GetServerInfo = Module['_SRB2_GetServerInfo'] = makeInvalidEarlyAccess('_SRB2_GetServerInfo');
var _SRB2_NetworkReceive = Module['_SRB2_NetworkReceive'] = makeInvalidEarlyAccess('_SRB2_NetworkReceive');
var _SRB2_NetworkClosed = Module['_SRB2_NetworkClosed'] = makeInvalidEarlyAccess('_SRB2_NetworkClosed');
...
var _change_resolution_force = Module['_change_resolution_force'] = makeInvalidEarlyAccess('_change_resolution_force');
var _inject_text = Module['_inject_text'] = makeInvalidEarlyAccess('_inject_text');
var _inject_keycode = Module['_inject_keycode'] = makeInvalidEarlyAccess('_inject_keycode');
var _unlock_mouse = Module['_unlock_mouse'] = makeInvalidEarlyAccess('_unlock_mouse');
var _SRB2_AddMouseDelta = Module['_SRB2_AddMouseDelta'] = makeInvalidEarlyAccess('_SRB2_AddMouseDelta');
var _mouse_button_down = Module['_mouse_button_down'] = makeInvalidEarlyAccess('_mouse_button_down');
var _mouse_button_up = Module['_mouse_button_up'] = makeInvalidEarlyAccess('_mouse_button_up');
var _mouse_wheel = Module['_mouse_wheel'] = makeInvalidEarlyAccess('_mouse_wheel');
...
var dynCall_viiffiiffiii = makeInvalidEarlyAccess('dynCall_viiffiiffiii');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['COM_ImmedExecute'] != 'undefined', 'missing Wasm export: COM_ImmedExecute');
  assert(typeof wasmExports['pause_loop'] != 'undefined', 'missing Wasm export: pause_loop');
  assert(typeof wasmExports['resume_loop'] != 'undefined', 'missing Wasm export: resume_loop');
  assert(typeof wasmExports['SRB2_SendGreenTerminal'] != 'undefined', 'missing Wasm export: SRB2_SendGreenTerminal');
  ...
  assert(typeof wasmExports['SRB2_SetDirectAction2'] != 'undefined', 'missing Wasm export: SRB2_SetDirectAction2');
  assert(typeof wasmExports['SRB2_SetAnalogStick'] != 'undefined', 'missing Wasm export: SRB2_SetAnalogStick');
  assert(typeof wasmExports['SRB2_ClearAnalogStick'] != 'undefined', 'missing Wasm export: SRB2_ClearAnalogStick');
  assert(typeof wasmExports['SRB2_KeyboardNeeded'] != 'undefined', 'missing Wasm export: SRB2_KeyboardNeeded');
  assert(typeof wasmExports['fflush'] != 'undefined', 'missing Wasm export: fflush');
  assert(typeof wasmExports['strerror'] != 'undefined', 'missing Wasm export: strerror');
  assert(typeof wasmExports['SRB2_LOG'] != 'undefined', 'missing Wasm export: SRB2_LOG');
  assert(typeof wasmExports['SRB2_ClearServerList'] != 'undefined', 'missing Wasm export: SRB2_ClearServerList');
  assert(typeof wasmExports['SRB2_AddServerToList'] != 'undefined', 'missing Wasm export: SRB2_AddServerToList');
  assert(typeof wasmExports['SRB2_FinishServerList'] != 'undefined', 'missing Wasm export: SRB2_FinishServerList');
  ...
  assert(typeof wasmExports['change_resolution_force'] != 'undefined', 'missing Wasm export: change_resolution_force');
  ...
  assert(typeof wasmExports['unlock_mouse'] != 'undefined', 'missing Wasm export: unlock_mouse');
  assert(typeof wasmExports['SRB2_AddMouseDelta'] != 'undefined', 'missing Wasm export: SRB2_AddMouseDelta');
  assert(typeof wasmExports['mouse_button_down'] != 'undefined', 'missing Wasm export: mouse_button_down');
  assert(typeof wasmExports['mouse_button_up'] != 'undefined', 'missing Wasm export: mouse_button_up');
  ...
  assert(typeof wasmExports['dynCall_viiffiiffiii'] != 'undefined', 'missing Wasm export: dynCall_viiffiiffiii');
  ...
  _COM_ImmedExecute = Module['_COM_ImmedExecute'] = createExportWrapper('COM_ImmedExecute', wasmExports['COM_ImmedExecute'], 1);
  _pause_loop = Module['_pause_loop'] = createExportWrapper('pause_loop', wasmExports['pause_loop'], 0);
  _resume_loop = Module['_resume_loop'] = createExportWrapper('resume_loop', wasmExports['resume_loop'], 0);
  _SRB2_SendGreenTerminal = Module['_SRB2_SendGreenTerminal'] = createExportWrapper('SRB2_SendGreenTerminal', wasmExports['SRB2_SendGreenTerminal'], 1);
  ...
  _SRB2_SetDirectAction2 = Module['_SRB2_SetDirectAction2'] = createExportWrapper('SRB2_SetDirectAction2', wasmExports['SRB2_SetDirectAction2'], 2);
  _SRB2_SetAnalogStick = Module['_SRB2_SetAnalogStick'] = createExportWrapper('SRB2_SetAnalogStick', wasmExports['SRB2_SetAnalogStick'], 2);
  _SRB2_ClearAnalogStick = Module['_SRB2_ClearAnalogStick'] = createExportWrapper('SRB2_ClearAnalogStick', wasmExports['SRB2_ClearAnalogStick'], 0);
  _SRB2_KeyboardNeeded = Module['_SRB2_KeyboardNeeded'] = createExportWrapper('SRB2_KeyboardNeeded', wasmExports['SRB2_KeyboardNeeded'], 0);
  _fflush = createExportWrapper('fflush', wasmExports['fflush'], 1);
  _strerror = createExportWrapper('strerror', wasmExports['strerror'], 1);
  _SRB2_LOG = Module['_SRB2_LOG'] = createExportWrapper('SRB2_LOG', wasmExports['SRB2_LOG'], 1);
  _SRB2_ClearServerList = Module['_SRB2_ClearServerList'] = createExportWrapper('SRB2_ClearServerList', wasmExports['SRB2_ClearServerList'], 0);
  _SRB2_AddServerToList = Module['_SRB2_AddServerToList'] = createExportWrapper('SRB2_AddServerToList', wasmExports['SRB2_AddServerToList'], 7);
  _SRB2_FinishServerList = Module['_SRB2_FinishServerList'] = createExportWrapper('SRB2_FinishServerList', wasmExports['SRB2_FinishServerList'], 0);
  ...
  _change_resolution_force = Module['_change_resolution_force'] = createExportWrapper('change_resolution_force', wasmExports['change_resolution_force'], 2);
  ...
  _unlock_mouse = Module['_unlock_mouse'] = createExportWrapper('unlock_mouse', wasmExports['unlock_mouse'], 0);
  _SRB2_AddMouseDelta = Module['_SRB2_AddMouseDelta'] = createExportWrapper('SRB2_AddMouseDelta', wasmExports['SRB2_AddMouseDelta'], 2);
  _mouse_button_down = Module['_mouse_button_down'] = createExportWrapper('mouse_button_down', wasmExports['mouse_button_down'], 1);
  _mouse_button_up = Module['_mouse_button_up'] = createExportWrapper('mouse_button_up', wasmExports['mouse_button_up'], 1);
  ...
  dynCall_viiffiiffiii = dynCalls['viiffiiffiii'] = createExportWrapper('dynCall_viiffiiffiii', wasmExports['dynCall_viiffiiffiii'], 12);
...
var wasmImports = {
  /** @export */
  SRB2_CloseSocket: _SRB2_CloseSocket,
  /** @export */
  SRB2_ConnectTo: _SRB2_ConnectTo,
  /** @export */
  SRB2_InitNetwork: _SRB2_InitNetwork,
  /** @export */
  SRB2_ListenOn: _SRB2_ListenOn,
  /** @export */
  SRB2_NetworkSend: _SRB2_NetworkSend,
  /** @export */
  SRB2_RequestServerList: _SRB2_RequestServerList,
  /** @export */
